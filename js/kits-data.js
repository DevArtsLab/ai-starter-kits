...
const KITS = [
  ...
  },
  {
    ...
    org: "openclaw",
    bestFor:
      "A self-hosted personal AI agent you talk to over WhatsApp, Telegram or Slack — runs on your own hardware and keeps working while you sleep.",
    ...
    costFriendliness: 6,
    docsQuality: 7,
    pricing: "Free (you pay model usage)",
  ...
  },
  {
    ...
    org: "intel",
    bestFor:
      "A polished desktop app for local image generation and LLM chat on Intel Arc and Core Ultra PCs — no cloud, no API keys.",
    docs: "https://github.com/intel/AI-Playground",
    category: "Local / Self-Hosted",
    difficulty: 1,
    timeToHelloWorld: 20,
    maturity: 5,
    ...
    costFriendliness: 7,
    docsQuality: 6,
    pricing: "Free / OSS (Intel Arc / Core Ultra hardware)",
    models: ["Llama", "Phi", "Stable Diffusion"],
    hasUI: true,
    hasBackend: false,
    hasEvals: false,
    requiresKey: false,
  ...
  },
  {
    ...
    org: "enescingoz",
    bestFor:
      "280+ ready-to-import n8n workflow templates — AI agents, RAG chatbots, email automation and document processing.",
    docs: "https://github.com/enescingoz/awesome-n8n-templates#readme",
    category: "Reference / Cookbook",
    difficulty: 1,
    timeToHelloWorld: 10,
    maturity: 6,
    ...
    costFriendliness: 8,
    docsQuality: 7,
    pricing: "Free templates (n8n + model costs apply)",
    models: ["OpenAI", "Anthropic", "Ollama"],
    license: "CC-BY-4.0",
    hasUI: false,
    hasBackend: false,
